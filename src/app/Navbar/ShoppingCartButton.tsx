// we add the use client here to allow it to use javascipt to close the dropdown
// because server component is not allow to use javascript
"use client"
...
export default function ShoppingCartButton({ cart }: ShoppingCartProps) {
    // to close the dropdown, delete the focus from it so it closed
